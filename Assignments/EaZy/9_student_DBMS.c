...
int search_student(int temp_roll_number)
{
    ...
    if(actual_roll_number >= 0)
    {
        ...
        printf("|%-20s |%-2d/%-2d/%-4d |%-20d |%-20d |%-2d/%-2d/%-14d|", student[actual_roll_number].name, 
                                                                       student[actual_roll_number].DOB.dd, 
                                                                       student[actual_roll_number].DOB.mm, 
                                                                       student[actual_roll_number].DOB.yy, 
                                                               student[actual_roll_number].current_course, 
                                                                      student[actual_roll_number].roll_no, 
                                                             student[actual_roll_number].DAY_OF_ENROLL.dd, 
                                                             student[actual_roll_number].DAY_OF_ENROLL.mm, 
                                                             student[actual_roll_number].DAY_OF_ENROLL.yy);
